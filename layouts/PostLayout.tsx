    ...
    <SectionContainer>
      ...
      <article>
        <div>
          ...
          <div className="grid-rows-[auto_1fr] xl:grid xl:grid-cols-4 xl:gap-x-6 xl:divide-y-0">
              ...
              <div className="text-sm font-medium leading-5 xl:col-start-1 xl:row-start-2">
                {tags && (
                  <div className="py-4 xl:py-8">
                    <h2 className="text-xs capitalize tracking-wide text-gray-500 dark:text-gray-400">
                      Tags
                    </h2>
