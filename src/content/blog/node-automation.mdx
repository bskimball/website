...
raw SQL. All these apps have sensitive data so they are published to private repo. Once the application is tested
and working, I will write a CL program that executes on the scheduler of the operating system.
