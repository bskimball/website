---
title: 'Authenticating pfSense OpenVPN Against IBM i LDAP'
pubDate: '2022-10-02'
tags: ['ibmi', 'pfsense']
draft: false
description: 'Use the IBM i Tivoli LDAP server as a single source of truth for VPN and service authentication. Here is the full setup, including a Node.js script to sync user profiles.'
