---
title: 'Three Datacenters, One Career: From a Single Rack to Full Redundancy'
pubDate: '2023-10-13'
tags: ['datacenter', 'installation']
draft: false
description: 'A 12-hour overnight migration, redundant Nexus switches, and LACP LAGG groups. How we built a datacenter that sustains sub-1ms latency and zero-downtime maintenance.'
heroImage: /static/images/datacenter-install-2.jpg
heroImageOptimized: '../../assets/datacenter-install-2.jpg'
---
