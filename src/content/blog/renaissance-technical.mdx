...
description: 'How I used OpenCode and Gemini to build a "Renaissance Technical" design system that pits rigid grids against organic circles—and why AI is the brush, not the painter.'
pubDate: 'Jan 04 2026'
...
<Gallery
  ...
  slides={[
    {
      src: '/static/images/renaissance-technical-1.png',
    },
    { src: '/static/images/renaissance-technical-2.png' },
    { src: '/static/images/renaissance-technical-3.png' },
  ]}
/>
