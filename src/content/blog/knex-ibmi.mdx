---
title: 'A Production-Ready Knex Dialect for IBM i DB2'
pubDate: '2025-9-20'
tags: ['typescript', 'development', 'ibmi']
draft: false
description: 'Streaming queries, emulated RETURNING, multi-row inserts, and a custom migration runner. This is the Knex dialect I wish existed when I started building on IBM i.'
heroImage: /static/images/knex-ibmi-npm.png
heroImageOptimized: '../../assets/knex-ibmi-npm.png'
---
