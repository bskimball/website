---
title: 'A Modern Feathers.js Stack on IBM i: Real-Time APIs on DB2'
pubDate: '2023-08-27'
tags: ['development', 'reactjs', 'feathersjs', 'typescript', 'ibmi']
draft: false
description: 'Real-time WebSockets, REST APIs, and a Vite React frontend running directly on IBM i using Feathers.js and a custom Knex adapter for DB2.'
