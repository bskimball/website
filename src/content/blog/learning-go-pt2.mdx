---
title: 'Go Is the Right Choice for Network Tools. Here Is the Proof'
pubDate: 2024-1-20
tags: ['development', 'golang']
draft: false
description: 'Six months into Go, I rewrote a network scanner and built a custom event bus. The language is simpler than expected, with one big limitation on IBM i.'
