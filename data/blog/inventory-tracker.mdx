...
draft: false
summary: 'A full stack application that tracks inventory. Built using Laravel with a separate Vue SPA.'
---
...
<div className="flex space-x-8">
  <div>![blog preview](/static/images/inventory-tracker-lookup.png)</div>
  <div>![opportunity form](/static/images/inventory-tracker-lookup-filtered.png)</div>
</div>
