...
Since the announcement of Lucia being [deprecated](https://github.com/lucia-auth/lucia/discussions/1707), I went ahead
and switched the sessions to the guide mentioned at [lucia-next.pages.dev](https://lucia-next.pages.dev/). I also added
a few other fixes and niceties. I fixed an issue with screen flashes for dark mode.
